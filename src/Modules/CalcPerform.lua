...
local function doActorAttribsConditions(env, actor)
	...
	if actor.weaponData1.type and actor.weaponData2.type then
		...
		if ((env.data.weaponTypeInfo[actor.weaponData1.type].label or actor.weaponData1.type) ~= (env.data.weaponTypeInfo[actor.weaponData2.type].label or actor.weaponData2.type))
			or ((actor.weaponData1.type == actor.weaponData2.type) and ((actor.weaponData1.doesNotTypeMatch and not actor.weaponData2.doesNotTypeMatch) or (actor.weaponData2.doesNotTypeMatch and not actor.weaponData1.doesNotTypeMatch))) then
